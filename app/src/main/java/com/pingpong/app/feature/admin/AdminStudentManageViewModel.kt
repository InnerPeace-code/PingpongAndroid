...
@HiltViewModel
class AdminStudentManageViewModel @Inject constructor(
    private val adminRepository: AdminRepository,
    private val tokenProvider: TokenProvider
) : ViewModel() {

    private val _uiState = MutableStateFlow(AdminStudentManageUiState())
    val uiState: StateFlow<AdminStudentManageUiState> = _uiState
    ...
    fun refresh() {
        viewModelScope.launch {
            ...
            val result = adminRepository.getStudents()
            result
                .onSuccess { students ->
...
data class AdminStudentManageUiState(
